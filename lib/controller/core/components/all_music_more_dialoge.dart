...
import '../../../presentation/playlist/screen_playlist.dart';
    ...
    builder: (context) {
      ...
      return AlertDialog(
        ...
        actions: [
          TextButton(
              onPressed: () {
                playlistProvider.nameController.clear();
                Navigator.pop(context);
                createNewPlayList(context, playlistProvider.formKey, playlistProvider.nameController);
              },
              child: Text(
                'New Playlist',
                style: TextStyle(color: componentsColor, fontWeight: FontWeight.w500),
